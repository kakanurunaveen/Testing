...
import pages.srs.BranchCreation;
import pages.srs.Generic;
import pages.srs.Homepage;
import pages.srs.Loginpage;
import pages.srs.NewBranch;
import testbase.Base;

public class Repository extends Base{
	
	static WebDriver driver;
	public static void launch(String url, String brow)
	{
		if(brow.equalsIgnoreCase("firefox"))
		{
			System.setProperty(data("firefox_driver"), data("firefox_path"));
