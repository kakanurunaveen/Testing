...
public class Data {
	...
	public static String folderpath = Base.data("exceldatafolderpath");
	static Workbook wb;
	static Sheet sh;
	static WritableWorkbook wwb;
	static WritableSheet wsh;
	
	public static void excel_con(String filename, String sheetname)
	{
			try {
	...
	public static void outputexcelcon(String ifilename,String ofilename,String sheet)
	{
		try {
